#!/usr/bin/env python3
"""
finetune_mt5small.py - Fine-tune mt5 for multilingual summarization using LoRA
...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description="Fine-tune google/mt5-small for multilingual summarization")
    parser.add_argument("--model_name", type=str, default="google/mt5-small",
                        help="Model name or path (default: google/mt5-small)")
    ...
    parser.add_argument("--wandb_project", type=str, default="mulsum-mt5small",
                        help="Weights & Biases project name (default: mulsum-mt5small)")
    ...
    run_name = args.wandb_run_name or f"mt5small-{args.language}-r{args.lora_r}-lr{args.learning_rate}-simple-prompt"
    wandb.init(
    ...
    # Load tokenizer with special tokens for mt5small
