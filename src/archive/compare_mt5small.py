#!/usr/bin/env python3
"""
compare_mt5small.py - Qualitatively compare base and fine-tuned google/mt5-small models
...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description="Compare base and fine-tuned google/mt5-small models")
    ...
    # Ensure padding token is set correctly for Phi
    ...
    console.print(Panel(
        f"[bold blue]Comparing Base google/mt5-small Model vs. Fine-tuned google/mt5-small Model[/bold blue]\n"
    ...
    if calculate_rouge and all_metrics["base_model"]["rouge-1"] and all_metrics["finetuned_model"]["rouge-1"]:
        ...
        for model_name, metrics in all_metrics.items():
            ...
            metrics_table.add_row(
                "Base google/mt5-small Model" if model_name == "base_model" else "Fine-tuned google/mt5-small Model",
                f"{avg_rouge1:.4f}",
                f"{avg_rouge2:.4f}",
                f"{avg_rougeL:.4f}"
            )
