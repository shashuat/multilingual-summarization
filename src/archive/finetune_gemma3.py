...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description="Fine-tune google/gemma-3-1b-it for multilingual summarization")
    parser.add_argument("--model_name", type=str, default="google/gemma-3-1b-it",
                        help="Model name or path (default: google/gemma-3-1b-it)")
    ...
    parser.add_argument("--wandb_project", type=str, default="mulsum-gemma-3-1b-it",
                        help="Weights & Biases project name (default: mulsum-gemma-3-1b-it)")
    ...
    run_name = args.wandb_run_name or f"gemma-3-1b-it-{args.language}-r{args.lora_r}-lr{args.learning_rate}-simple-prompt"
    wandb.init(
